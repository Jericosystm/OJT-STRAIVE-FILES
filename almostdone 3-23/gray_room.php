...
<head>
    ...
    <style>
        ...
        .navbar { 
            background: #475569; padding: 0 2.5rem; 
        ...
        .container { 
            height: calc(100vh - 70px); padding: 1.5rem 2rem;
        ...
        .map-grid-container { 
            ...
            padding: 2rem; border-radius: 30px; border: 1px solid rgba(255,255,255,0.8); 
        ...
        .seat-box {
            border-radius: 14px; text-align: center; border: 1px solid transparent; 
        ...
        .drag-over { background: #f1f5f9 !important; transform: scale(1.05) !important; border: 2px solid var(--primary) !important; }
...
<nav class="navbar">
    <a href="prod_map.php" class="nav-back-btn" title="Back to Overview"><i class="fa-solid fa-circle-arrow-left"></i></a>
    <div style="color: white; font-weight: 900; font-size: 1.4rem; letter-spacing: -0.02em;">OJTBox | Gray Room Dashboard</div>
</nav>
        ...
        <div class="column-container">
            ...
            ?>
                <div class="seat-box <?php echo $status; ?>" 
                    ...
                    <div style="font-size: 0.6rem; color: #64748b; margin-top: 2px; font-weight: 600;">
