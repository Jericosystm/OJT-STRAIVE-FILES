...
<head>
    ...
    <style>
        ...
        body { 
            ...
            height: 100vh; 
            overflow: hidden; 
            /* Added transition and animation from Movement Tab */
        ...
        /* Ensure sticky columns don't break the row slide effect */
        ...
        #baselineTable { 
            ...
            border-spacing: 0 4px; /* Added spacing for cleaner "row-sliding" look */
        }
        ...
        /* --- REMAINING STYLES (Search, Filter, Modals) --- */
        .filter-group {
            display: flex;
            align-items: center;
        ...
        /* ... existing styles for search-wrapper, btn-modern, etc ... */
        .btn-modern { border-radius: 8px; padding: 8px 16px; font-weight: 600; transition: 0.3s; }
        ...
        .modal-content { 
            ...
            color: var(--text-main); 
            border: 1px solid var(--border-color); 
            backdrop-filter: blur(8px); /* Glass effect from Movement tab */
        }
    </style>
</head>
