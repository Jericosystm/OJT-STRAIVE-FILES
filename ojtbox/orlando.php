...
<head>
    ...
    <style>
        ...
        html, body { height: 100vh; margin: 0; padding: 0; background: var(--bg); color: var(--text-dark); overflow: hidden; font-family: sans-serif; }
        
        .container { height: calc(100vh - 72px); padding: 1.5rem 2rem; display: flex; flex-direction: column; box-sizing: border-box; max-width: 1200px; margin: 0 auto; }
...
<div class="container">
    ...
    <div class="status-legend">
        ...
        <div class="legend-item" style="border-left: 1px solid var(--border); padding-left: 20px;">Total: 20</div>
    </div>
</div>
...
<script>
    ...
    function handleDrop(e) {
        ...
        if (sourceId && targetId && sourceId !== targetId) performSwap(sourceId, targetId);
    ...
    function performSwap(src, tgt) {
        ...
        fetch('orlando.php', { method: 'POST', body: formData })
