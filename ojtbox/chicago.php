...
$page_title = "CHICAGO DEPARTMENT";
$back_link = "prod_map.php"; // Overriding the automatic dashboard link to go back to the Floor Selection
...
if(isset($_POST['swap_seats'])) {
    ...
    try {
        ...
        // 3. SWAP IN INVENTORY (Physical Port Sync)
...
<head>
    ...
    <style>
        ...
        /* Support for Dark Mode and Layout Fixes */
        [data-theme="dark"] {
            --bg: #121212;
            --card-bg: #1e1e1e;
            --text-dark: #f1f5f9;
        ...
        #searchInput:focus { border-color: var(--primary-orange); width: 350px; }
        ...
        .seat-box:hover { transform: translateY(-5px); box-shadow: var(--shadow-hover); border-color: var(--primary-orange); }
        ...
        .edit-sidebar { position: fixed; right: 25px; bottom: 100px; background: var(--card-bg); padding: 20px; border-radius: 20px; box-shadow: var(--shadow-hover); border: 1px solid var(--border); z-index: 100; display: flex; flex-direction: column; gap: 10px; }
        .edit-mode-active .seat-box { cursor: grab; border: 2px dashed var(--primary-orange) !important; }
        .drag-over { background: var(--primary-orange) !important; color: white !important; }
        ...
        .dimmed { opacity: 0.15; filter: blur(1px); transform: scale(0.95); }

        .modal-overlay { display: none; position: fixed; inset: 0; background: rgba(0, 0, 0, 0.7); backdrop-filter: blur(5px); z-index: 2000; }
...
<div class="container">
    <div class="header-row">
        <div><h1>Production Floor Plan</h1></div>
    ...
    <div class="status-legend">
        <div class="legend-item"><div class="dot" style="background: #22c55e;"></div>Occupied: <span style="color: #22c55e;"><?php echo $occupied_count; ?></span></div>
        <div class="legend-item"><div class="dot" style="background: #cbd5e1;"></div>Vacant: <span style="color: var(--text-muted);"><?php echo $vacant_count; ?></span></div>
        <div class="legend-item" style="border-left: 1px solid var(--border); padding-left: 20px;">Seats: <?php echo $total_seats; ?></div>
    </div>
</div>
    ...
    <div class="modal-content">
        ...
        <form>
            ...
            <button type="button" onclick="closeModal()" 
                    style="width: 100%; padding: 0.8rem; background: var(--primary-orange); color:white; border:none; border-radius:10px; font-weight:700; cursor:pointer;">
                CLOSE
            </button>
        </form>
    </div>
...
<script>
    ...
    function toggleEditMode() {
        ...
        if (isEditMode) {
            ...
            label.innerText = "ON"; label.style.color = "var(--primary-orange)";
            seats.forEach(seat => {
