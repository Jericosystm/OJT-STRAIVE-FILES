...
<head>
    ...
    <style>
      ...
      .layout-wrapper {
            ...
            /* perspective: 1000px;  <-- REMOVED to straighten the view */
        }
       ...
       .table-container {
            ...
            padding: 25px;
            border-radius: 15px;
            box-shadow: 0 10px 0 0 var(--table-shadow), var(--shadow-hover); /* Adjusted shadow for flat look */
            display: flex;
            gap: 20px;
            /* transform: rotateX(5deg); <-- REMOVED to align the left side straight */
