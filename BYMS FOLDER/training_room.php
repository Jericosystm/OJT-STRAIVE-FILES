...
<head>
    ...
    <style>
        ...
        .container { height: calc(100vh - 60px); padding: 1.5rem 2.5rem; display: flex; flex-direction: column; box-sizing: border-box; max-width: 1400px; margin: 0 auto; position: relative; }
        ...
        /* Padding removed for the first column if you want it aligned too, or kept if only last column needs fix */
