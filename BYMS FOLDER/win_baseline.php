...
<head>
    ...
    <style>
        ...
        /* 1. Set a height and overflow on the container to enable internal scrolling */
        .table-responsive {
            max-height: 75vh; /* Adjust this value (e.g., 500px or 80vh) based on your preference */
            overflow-y: auto;
            overflow-x: auto;
        }
        ...
        .table thead th { 
            ...
            top: 0;           /* REQUIRED */
            z-index: 100;     /* Keeps header above the 'DONE' cells and search highlights */
        }

        /* 3. Fix for Bootstrap borders during scroll */
        .table {
        ...
        @keyframes pulse-orange {
            0% { box-shadow: inset 0 0 0 2px #ff6600; }
            50% { box-shadow: inset 0 0 0 5px rgba(255, 102, 0, 0.4); }
            100% { box-shadow: inset 0 0 0 2px #ff6600; }
        }
...
<body>
    ...
    <nav class="navbar" style="background-color: #2c3e50; color: white; display: flex; justify-content: space-between; padding: 12px 25px;">
    ...
    // MODIFIED SEARCH: Automatic filtering for Hostname and Asset Inventory
    function triggerSearch() {
        ...
        $("#baselineTable tbody tr").each(function() {
            ...
            // Toggle visibility if search term is found in either column
