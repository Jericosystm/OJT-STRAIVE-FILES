...
<head>
    ...
    <style>
        ...
        .map-grid { display: grid; grid-template-columns: repeat(5, 1fr); grid-template-rows: repeat(4, 1fr 25px); gap: 15px; width: 100%; height: 100%; }
    ...
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <div style="display: flex; gap: 15px; margin-top: 1rem;">
                <button type="submit" name="update_seat" style="flex:2; padding: 1rem; background: #2196f3; color: #fff; border:none; border-radius:14px; font-weight:800; cursor:pointer;">UPDATE</button>
