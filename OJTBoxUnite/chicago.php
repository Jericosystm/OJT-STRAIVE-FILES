...
<head>
    ...
    <style>
        ...
        .map-grid { display: grid; grid-template-columns: repeat(7, 1fr); grid-template-rows: 1fr 30px 1fr 30px 1fr 30px 1fr 30px 1fr; gap: 15px; width: 100%; height: 100%; }
        .walkway { grid-column: span 7; background: transparent; pointer-events: none; }
