...
<style>
    ...
    align-items: center;
    justify-content: center;
    /* ensure width and height are set to keep it circular */
}
</style>

<nav class="navbar">
    <div class="nav-left">
        <a href="<?php echo $back_link; ?>" class="back-btn" style="text-decoration: none; display: flex; align-items: center; justify-content: center;">
