...
<head>
    ...
    <style>
        :root {
            /* Variables synchronized with your header theme logic */
            --bg-dark: #0a0a0a;
            --card-bg: #111111;
        ...
        .header-section h1 { font-size: 2.5rem; margin: 0; font-weight: 700; color: var(--text-main); }
        ...
        .data-table tbody tr:hover { transform: translateX(10px); background: var(--input-bg); box-shadow: -5px 0 0 var(--primary-orange); }
        .data-table td { padding: 20px; border-top: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color); color: var(--text-main); }
        ...
        .modal-content { background: var(--card-bg); border: 1px solid var(--border-color); padding: 30px; width: 90%; max-width: 500px; border-radius: 20px; color: var(--text-main); }
        ...
        .action-btn { background: var(--input-bg); border: 1px solid var(--border-color); color: var(--text-main); padding: 8px; border-radius: 6px; cursor: pointer; transition: 0.3s; }
    </style>
</head>
<body>
