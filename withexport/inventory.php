...
// Mappings updated to match your database case sensitivity
    ...
    <main class="inventory-container">
        ...
        <div class="header-flex">
            <div class="search-box">
                <form action="" method="GET">
                    ...
                    <?php if (!empty($search_query)): ?>
                        <a href="?tab=<?php echo $current_tab; ?>" style="color: var(--text-gray); margin-right: 10px;">
                            <i class="fa-solid fa-xmark"></i>
                        </a>
                    <?php endif; ?>

                    <button type="submit" style="background:none; border:none; color:var(--primary-orange); cursor:pointer;">
            ...
            <div style="display:flex; gap:10px;">
                <button onclick="exportData()" class="action-btn" style="padding: 12px 20px; border-color: var(--neon-green); color: var(--neon-green);">
