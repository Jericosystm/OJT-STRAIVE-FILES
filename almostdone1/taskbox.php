...
// The % signs allow partial matching (e.g., "John" finds "John Doe")
$searchTerm = "%$search%";
...
// Sort by the most recently updated activity so "nearest" tasks are first
...
<head>
    ...
    <style>
        ...
        /* Updated Table Headers with Smooth Corners & Borders */
