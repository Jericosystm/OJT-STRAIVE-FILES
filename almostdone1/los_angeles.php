...
if(isset($_POST['swap_seats'])) {
    ...
    try {
        ...
        if (!empty($srcHost)) {
            // Step A: Move Source to Target's Cubicle with TEMP Hostname
        ...
        if (!empty($tgtHost)) {
            // Step B: Move Target to Source's Cubicle
...
if(isset($_POST['update_seat'])) {
    ...
    // Syncing column names: using switch_port instead of campaign
