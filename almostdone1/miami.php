...
<head>
    ...
    <style>
        ...
        .map-grid-container { background: rgba(255, 255, 255, 0.6); backdrop-filter: blur(10px); padding: 2rem; border-radius: 30px; border: 1px solid rgba(255,255,255,0.8); flex-grow: 1; display: flex; align-items: center; justify-content: center; box-shadow: var(--shadow-soft); overflow: hidden; }
        ...
        .seat-box { border-radius: 14px; text-align: center; border: 1px solid transparent; background: var(--card-bg); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; box-shadow: var(--shadow-soft); padding: 5px; }
        ...
        .status-legend { display: flex; justify-content: center; gap: 30px; margin-top: 1.5rem; background: white; padding: 0.8rem 2rem; border-radius: 50px; width: fit-content; margin-left: auto; margin-right: auto; box-shadow: var(--shadow-soft); border: 1px solid var(--border); }
...
<nav class="navbar">
    ...
    <div style="color: white; font-weight: 900; font-size: 1.4rem; letter-spacing: -0.02em;">OJTBox | Miami Dashboard</div>
</nav>
...
<div class="container">
    ...
    // This ensures the label matches the data position
