...
<head>
    ...
    /* Grid Span Logic maintained from User code */
    ...
    <main class="dashboard-wrapper">
        <div id="main-grid" class="dashboard-container">
            ...
            <a href="baseline.php" class="card" id="btn-baseline">
                ...
                <p>Win BaseLine</p>
                <span class="data-text">Stable Build</span>
            </a>
