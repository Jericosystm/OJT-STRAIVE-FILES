...
<head>
    ...
    <style>
        ...
        .header-row h1 { font-weight: 800; font-size: 1.8rem; letter-spacing: -0.03em; margin: 0; background: linear-gradient(to right, #e8955f, #ffb07c); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .seat-box { border-radius: 16px; text-align: center; border: 1px solid transparent; background: var(--card-bg); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; box-shadow: var(--shadow-soft); }
        .seat-box:hover { transform: translateY(-5px); box-shadow: var(--shadow-hover); z-index: 10; border-color: var(--primary); }
        ...
        .drag-over { background: #fff7ed !important; transform: scale(1.1) !important; border: 2px solid var(--primary) !important; }
...
<nav class="navbar">
    ...
    <div style="color: white; font-weight: 900; font-size: 1.4rem;">OJTBox | Phoenix Dashboard</div>
</nav>
    ...
    <div class="map-grid-container">
        <div class="map-grid" id="mapGrid">
            ...
            for($i = 0; $i < 35; $i++): 
                ...
                $switch_port = $row_data['switch_port'] ?? 'Not Set'; // Changed from campaign
            ?>
...
<div id="modalOverlay" class="modal-overlay">
    <div class="modal-content">
        <h2 style="margin:0; font-weight:800;">Update Station</h2>
        <form method="POST">
...
<script>
    // All original Drag/Drop and Search logic preserved
