    ...
    <main class="log-container">
        <div class="header-flex">
            ...
            <div style="display: flex; gap: 15px; align-items: center;">
                <button onclick="exportLogs()" class="btn-edit" style="height: 40px; display: flex; align-items: center; gap: 8px; border-color: var(--neon-green); color: var(--neon-green);">
        ...
        <table class="data-table" id="movementTable">
            <thead>
                <tr>
                    <th>Asset Details</th>
                    <th>Identifier</th>
                    <th>Accessories</th> <th>Agent / Superior</th>
                    <th>Status</th>
                    <th>Date</th>
                    <th>Operator</th>
            ...
            <tbody>
                <?php if ($result->num_rows > 0): ?>
                    ...
                    <tr class="log-row">
                        ...
                        <td style="font-size:0.8rem; color:var(--text-main);"> <?php echo !empty($row['accessories']) ? htmlspecialchars($row['accessories']) : '<span style="color:var(--text-gray); font-style:italic;">None</span>'; ?>
                        </td>
                        <td>
                        ...
                        <td style="text-align: center;">
                            <button type="button" class="btn-edit" 
                                    ...
                                    data-accessories="<?php echo htmlspecialchars($row['accessories'] ?? ''); ?>" 
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="8" style="text-align:center; padding:60px; color:var(--text-gray);">NO TRANSACTION DATA DETECTED.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </main>
        ...
        <div class="modal-content">
            ...
            <form id="manualLogForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="accessories" placeholder="e.g., Charger, Mouse, Headset">
                </div>
                <div class="form-group">
   ...
   <div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editLogForm">
            ...
            <div class="form-group">
                <label>Accessories</label>
                <input type="text" name="accessories" id="edit_accessories">
            </div>
...
<script>
    ...
    function openEditModal(btn) {
        ...
        // Populate accessories field in edit modal
        document.getElementById('edit_accessories').value = btn.getAttribute('data-accessories');
    ...
    function exportLogs() {
        ...
        window.location.href = `export_movement.php?type=${currentType}`;
    }
</script>
</body>
</html>