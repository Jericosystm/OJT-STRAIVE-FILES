...
<head>
    ...
    <style>
        ...
        /* Container adjusted for header height */
        ...
        #searchInput { width: 300px; padding: 0.8rem 1rem 0.8rem 2.5rem; border-radius: 14px; border: 1px solid var(--border); background: var(--card-bg); color: var(--text-dark); font-size: 0.9rem; transition: all 0.3s; outline: none; box-shadow: var(--shadow-soft); }
        ...
        .edit-sidebar { position: fixed; right: 20px; top: 90px; background: var(--card-bg); color: var(--text-dark); padding: 20px; border-radius: 20px; box-shadow: var(--shadow-hover); border: 1px solid var(--border); z-index: 100; display: flex; flex-direction: column; gap: 10px; }
        ...
        .status-legend { display: flex; justify-content: center; gap: 30px; margin-top: 1.5rem; background: var(--card-bg); color: var(--text-dark); padding: 0.8rem 2rem; border-radius: 50px; width: fit-content; margin: 1.5rem auto 0; box-shadow: var(--shadow-soft); border: 1px solid var(--border); }
