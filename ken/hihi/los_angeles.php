...
<head>
    ...
    <style>
        ...
        #searchInput:focus { border-color: var(--primary); width: 350px; box-shadow: 0 0 0 4px rgba(144, 190, 109, 0.15); }

        /* Effect: Glassmorphism container */
        ...
        /* Effect: Dragging styles */
        .edit-mode-active .seat-box { cursor: grab; border: 2px dashed var(--primary) !important; animation: none; }
        .drag-over { background: #ecfdf5 !important; transform: scale(1.05) !important; border: 2px solid var(--primary) !important; box-shadow: 0 0 15px rgba(144, 190, 109, 0.4) !important; }
        ...
        .dimmed { opacity: 0.15; filter: blur(2px); transform: scale(0.9); pointer-events: none; }
...
<nav class="navbar">
    ...
    <div style="color: white; font-weight: 900; font-size: 1.4rem; letter-spacing: -0.02em;">OJTBox | Los Angeles Dashboard</div>
</nav>
...
<div class="container">
    ...
    <div class="status-legend">
        <div class="legend-item">
            <div class="dot" style="background: #22c55e; box-shadow: 0 0 10px rgba(34, 197, 94, 0.4);"></div>
            Occupied: <span style="color: #166534;"><?php echo $occupied_count; ?></span>
        </div>
        <div class="legend-item">
            <div class="dot" style="background: #cbd5e1; box-shadow: 0 0 8px rgba(148, 163, 184, 0.4);"></div>
