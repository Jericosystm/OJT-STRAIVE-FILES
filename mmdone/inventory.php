...
$user_role = $_SESSION['role'] ?? 'euc_user'; // Default to User if not set
...
<body>
    ...
    <?php elseif($item['location'] == 'Return'): ?>
        <span class="loc-badge" style="background-color: #fef3c7; color: #92400e;">
            <i class="fa-solid fa-rotate-left"></i> Return
        </span>
    <?php elseif($item['location'] == 'Release'): ?>
        <span class="loc-badge" style="background-color: #dcfce7; color: #166534;">
            <i class="fa-solid fa-truck-ramp-box"></i> Release
        </span>
    <?php else: ?>
...
const cubicleData = <?php echo json_encode($cubicles); ?>;
    ...
    // Only show extra fields if Onsite is selected
