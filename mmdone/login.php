...
<head>
    ...
    <style>
        ...
        .logo-loop-container {
            ...
            overflow: hidden;
            padding: 20px 0;
            z-index: 15; /* Siniguro na nasa itaas ito ng background */
        ...
        /* REVISED: Spacing for buttons */
        .button-group {
            display: flex;
            justify-content: center;
            gap: 40px; /* Dinagdagan ang layo ng Get Started at Learn More */
        }
...
<body>
    ...
    <script>
        ...
        function showLogin() {
            ...
            // REVISED: Logo loop remains visible
