...
<body>
    ...
    <nav class="navbar">
        <div class="nav-left">
            <div class="logo">
                <a href="index.php" style="color: white; text-decoration: none; margin-right: 15px;"><i class="fa-solid fa-arrow-left"></i></a>
                OJTBox | Task Box
            </div>
        </div>
        <div class="nav-right">
            <span style="color:white">Hi, <?php echo htmlspecialchars($username); ?>!</span>
            <div class="user-menu">
                <i class="fa-regular fa-user" style="cursor:pointer; font-size: 1.2rem;"></i>
